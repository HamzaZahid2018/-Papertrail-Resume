...
export const ResumePreview = ({ data }: ResumePreviewProps) => {
  ...
  return (
    // #resume-preview-print is targeted by @media print CSS in index.css
    <div
      id="resume-preview-print"
      className="bg-white p-8 shadow-sm border border-[#C9D3C6] rounded-2xl min-h-[1100px] w-full text-[#1E3A34] flex flex-col justify-start select-none overflow-y-auto max-h-[85vh]"
